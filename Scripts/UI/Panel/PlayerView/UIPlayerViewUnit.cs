...
namespace click2wait
{
	...
	public partial class UIPlayerViewUnit : UIPlayerViewPanel<UnitSyncStruct, UnitManager>
	{
		
		public static UIPlayerViewUnit singleton;
		
		
		
		protected ObjectType		objectType = ObjectType.Unit;
		...
		// -------------------------------------------------------------------------------
		public override void Init(GameObject localPlayer, UnitSyncStruct _entry)
		{
