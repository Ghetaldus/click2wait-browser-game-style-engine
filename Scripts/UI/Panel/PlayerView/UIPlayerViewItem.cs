...
namespace click2wait
{
	...
	public partial class UIPlayerViewItem : UIPlayerViewPanel<ItemSyncStruct, ItemManager>
	{
		
		public static UIPlayerViewItem singleton;
		
		
		
		protected ObjectType		objectType = ObjectType.Item;
		...
		// -------------------------------------------------------------------------------
		public override void Init(GameObject localPlayer, ItemSyncStruct _entry)
		{
