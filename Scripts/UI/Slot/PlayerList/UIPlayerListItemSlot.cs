...
namespace click2wait
{
	...
	public partial class UIPlayerListItemSlot : UISlot<ItemSyncStruct>
	{
		
		// -------------------------------------------------------------------------------
		public override void Init(GameObject _localPlayer, ref ItemSyncStruct _entry)
		{
			...
			if (entry.Active)
			{
				...
				button.onClick.AddListener(() => { UIPlayerViewItem.singleton.Init(localPlayer, entry); });
