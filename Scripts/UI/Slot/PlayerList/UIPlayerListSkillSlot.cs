...
namespace click2wait
{
	...
	public partial class UIPlayerListSkillSlot : UISlot<SkillSyncStruct>
	{
		
		// -------------------------------------------------------------------------------
		public override void Init(GameObject _localPlayer, ref SkillSyncStruct _entry)
		{
			...
			if (entry.Active)
			{
				...
				button.onClick.AddListener(() => { UIPlayerViewSkill.singleton.Init(localPlayer, entry); });
