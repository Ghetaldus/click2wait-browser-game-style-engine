...
namespace click2wait
{
	...
	public partial class UIPlayerListEquipmentSlot : UISlot<EquipmentSyncStruct>
	{
		
		// -------------------------------------------------------------------------------
		public override void Init(GameObject _localPlayer, ref EquipmentSyncStruct _entry)
		{
			...
			if (entry.Active)
			{
				...
				button.onClick.AddListener(() => { UIPlayerViewEquipment.singleton.Init(localPlayer, entry); });
