...
namespace click2wait
{
	...
	public partial class UIPlayerListSpellSlot : UISlot<SpellSyncStruct>
	{
		
		// -------------------------------------------------------------------------------
		public override void Init(GameObject _localPlayer, ref SpellSyncStruct _entry)
		{
			...
			if (entry.Active)
			{
				...
				button.onClick.AddListener(() => { UIPlayerViewSpell.singleton.Init(localPlayer, entry); });
