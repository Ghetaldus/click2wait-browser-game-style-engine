...
namespace click2wait
{
	...
	public partial class UIPlayerListBuildingSlot : UISlot<BuildingSyncStruct>
	{
		
		// -------------------------------------------------------------------------------
		public override void Init(GameObject _localPlayer, ref BuildingSyncStruct _entry)
		{
			...
			if (entry.Active)
			{
				...
				button.onClick.AddListener(() => { UIPlayerViewBuilding.singleton.Init(localPlayer, entry); });
