...
namespace click2wait
{
	...
	public partial class UIPlayerListBuffSlot : UISlot<BuffSyncStruct>
	{
		
		// -------------------------------------------------------------------------------
		public override void Init(GameObject _localPlayer, ref BuffSyncStruct _entry)
		{
			...
			if (entry.Active)
			{
				...
				button.onClick.AddListener(() => { UIPlayerViewBuff.singleton.Init(localPlayer, entry); });
