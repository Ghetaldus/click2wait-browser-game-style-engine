...
namespace click2wait {
	...
	public partial class EnhancementManager
	{
		...
		public override void CmdSellEntry(int _slot, long _amount)
		{
			...
			if (syncEnhancements[index].CanSell)
		...
		{
			EnhancementSyncStruct entry = syncEnhancements[_index];
			entry.Remove(_amount);
			syncEnhancements[_index] = entry;
