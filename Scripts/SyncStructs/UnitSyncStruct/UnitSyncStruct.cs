...
namespace click2wait {
	...
	[System.Serializable]
	public partial struct UnitSyncStruct : ISyncableStruct<UnitTemplate>
	{
		...
		// -------------------------------------------------------------------------------
		public UnitSyncStruct(int _slot, UnitTemplate template, byte _state, double _timer, int _level)
		{
			slot	= _slot;
		...
		public UnitTemplate template
		{
			get
			{
				...
				if (!UnitTemplate.dict.ContainsKey(hash))
					throw new KeyNotFoundException("[Missing] UnitTemplate not found in Resources: " + hash);
	...
	public class SyncListUnitSyncStruct : SyncList<UnitSyncStruct> { }
