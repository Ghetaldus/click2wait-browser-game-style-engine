...
namespace click2wait {
	...
	[System.Serializable]
	public partial struct TechnologySyncStruct : ISyncableStruct<TechnologyTemplate>
	{
		...
		// -------------------------------------------------------------------------------
		public TechnologySyncStruct(int _slot, TechnologyTemplate template, byte _state, double _timer, int _level)
		{
			slot	= _slot;
	...
	public class SyncListTechnologySyncStruct : SyncList<TechnologySyncStruct> { }
