...
namespace click2wait {
	...
	public partial class CurrencyTemplate : PropertyTemplate
	{
		...
		[Header("Auto Production")]
		public AutoCurrencyProduction autoProduction;
		...
		private static Dictionary<int, CurrencyTemplate> _cache;
		...
		public static Dictionary<int, CurrencyTemplate> dict
    	{
			get
			{
				...
				if (_cache == null)
				{
					...
					CurrencyTemplate[] templates = Resources.LoadAll<CurrencyTemplate>(CurrencyTemplate.folderName);
