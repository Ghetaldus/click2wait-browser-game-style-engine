...
namespace click2wait {
	...
	public partial class RarityTemplate : ScriptableTemplate
	{
		...
		private static Dictionary<int, RarityTemplate> _cache;

		public static Dictionary<int, RarityTemplate> dict
    	{
			get
			{
				...
				if (_cache == null)
				{
					...
					RarityTemplate[] templates = Resources.LoadAll<RarityTemplate>(RarityTemplate.folderName);
